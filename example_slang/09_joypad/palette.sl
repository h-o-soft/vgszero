...
init_palette()
{
    ...
    vgs0_palette_set(0, 8, 5, 5, 5);
    vgs0_palette_set(0, 9, 16, 1, 1);
    vgs0_palette_set(0, 10, 18, 5, 5);
    vgs0_palette_set(0, 11, 21, 6, 6);
    vgs0_palette_set(0, 12, 14, 16, 4);
    vgs0_palette_set(0, 13, 18, 21, 6);
    vgs0_palette_set(0, 14, 17, 18, 9);
